...
import { Button, PageHero, PhoneLink, SectionHeader } from '../components/ui'
  ...
  Head: () => (
    <>
      ...
      {generatePageHead({
        ...
        description:
          'Get in touch with HO Oxygen Industries Pvt. Ltd. to place a gas order, request a quote, or ask about our services.',
        url: '/contact',
        keywords:
          'contact us, gas inquiry, order cylinders Nepal, Nepalgunj, gas supplier contact, HO Oxygen phone',
      })}
...
function ContactHero() {
  ...
  return <PageHero title={t('contact.hero.title')} subtitle={t('contact.hero.subtitle')} />
}
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5">
      ...
      <div>
        <label
          htmlFor="company"
          className="block font-body font-medium text-brand-dark text-sm mb-1"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <select id="gasType" className={inputClass(false)} {...register('gasType')}>
...
function ContactInfo() {
  ...
  return (
    <aside aria-label="Contact information">
      <SectionHeader title={t('contact.info.title')} align="left" className="mb-6" />
